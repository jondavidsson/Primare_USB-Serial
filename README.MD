...
- Copy directory `primare_receiver` to your `<config dir>/deps/lib/python3.10/site-packages` or '<config dir>/lib/python3.10/site-packages/' directory.
...
- **name** (*Optional*): Name of the device. (default = 'Primare Receiver')
